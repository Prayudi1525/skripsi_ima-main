            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Daily Pre Use Report</h5>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                                <p class="text-center">
                                    <strong>Record: 1 Jul, 2022 - 30 Jul, 2022</strong>
                                </p>
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-6">
                                <div class="description-block border-right">
                                    ...
                                    <span class="description-text">TOTAL RECORD</span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-3 col-6">
                                <div class="description-block border-right">
                                    <span class="description-percentage text-warning"><i class="fas fa-caret-left"></i> 90%</span>
                                    <h5 class="description-header">90</h5>
                                    <span class="description-text">TOTAL KONDISI BAIK</span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-3 col-6">
                                <div class="description-block">
                                    ...
                                    <span class="description-text">TOTAL KONDISI BURUK</span>
                                </div>
                                <!-- /.description-block -->
                            </div>
                            <!-- /.col -->
